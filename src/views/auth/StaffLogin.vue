          ...
          <Form @submit="handleLogin" class="login__form form" :validation-schema="loginSchema">
            <div class="login__row row">
              <div class="login__field-group form__field-group">
                <Field name="email-or-staff-id" v-slot="{ field, errors, errorMessage }" :validate-on-blur="true"
                  :validate-on-input="false">
                  <input type="text" v-model="form.emailOrId" v-bind="field" placeholder="Email or staff id" required />
            ...
            <div class="login__row row">
              <div class="login__field-group form__field-group">
                <Field name="password" v-model="form.password" v-slot="{ field, errors, errorMessage }"
                  :validate-on-blur="true" :validate-on-input="false">
