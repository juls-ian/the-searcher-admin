...
// Allow the file to be dragged over the uploader area without the browser blocking it
 ...
 * @drop: Actually handles the file once the user drops it on the uploader
 *  */
const handleDrop = (e) => {
  e.preventDefault()
  isDragging.value = false
  ...
  <div class="uploader">
    ...
    <div v-if="file" class="uploader__file">
      <div class="uploader__file-icon">
        ...
        <img
          v-if="previewUrl && (fileType === 'image' || fileType === 'video')"
          :src="previewUrl"
          alt="File preview"
